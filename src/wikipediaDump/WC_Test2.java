...
public class WC_Test2 {
	public static void main(String args[]) throws Exception{
		String index = "wiki-dump-index";
		...
		Query query = new TermQuery(new Term("category", queryStr));
        ...
        for (ScoreDoc scoreDoc : docs.scoreDocs) {
            ...
            for( IndexableField f : doc.getFields() ){
            	if(!f.name().contains("term")) System.out.println( f.name() + ":" + f.stringValue());
