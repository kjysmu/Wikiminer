...
public class SCHype {
        ...
        public static void main(String[] args) {
        		...
        		//String datapath = "D:\\project\\flickrtaglire\\PhotoMiner\\graph_results";
        		//String datalist[] = new File(datapath).list();

        		String datapath = "D:\\Development\\tg";
        		String datalist[] = new File(datapath).list();
                ...
                */
                ...
                for(String dlist : datalist){
                	System.out.println("Clustering start : " + dlist);
                	dname = dlist.replaceAll(".txt","");
                	
                	hg = new HyperGraph("graph_results/"+ dlist, dir, weighted);
	                if (dir){
	                ...
	                //clust.writeClusters( "cluster_results/" + dname + ".nodes.txt");
	                //clust.writeClusterEdges( "cluster_results/" + dname + ".edges.txt");
	                
	                //clust.writeClusterFeatures( "feature_results/" + dname + "_feature.txt");
	                
	                
	                //clust.saveToHtml(dname);
